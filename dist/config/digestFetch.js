...
export class DigestFetch {
    ...
    fetch(url, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield fetch(url, this.addAuth(url, options));
            if (resp.status == 401 ||
                (resp.status == this.statusCode && this.statusCode)) {
                this.hasAuth = false;
                yield this.parseAuth(resp.headers.get("www-authenticate"));
                if (this.hasAuth) {
                    const respFinal = yield fetch(url, this.addAuth(url, options));
    ...
    addAuth(url, options) {
        ...
        let ha1 = this.precomputedHash
            ? this.password
            : DigestFetch.computeHash(this.user, this.digest.realm, this.password);
...
//# sourceMappingURL=digestFetch.js.map